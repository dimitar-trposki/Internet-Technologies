...
namespace AV8.Controllers
{
    public class MoviesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Title,DownloadURL,ImageURL,Rating")] Movie movie)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Title,DownloadURL,ImageURL,Rating")] Movie movie)
        {
            if (ModelState.IsValid)
            {
